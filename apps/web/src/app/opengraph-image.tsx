...
export const alt = 'Podex - AI-powered cloud IDE with multi-agent collaboration';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image() {
  return new ImageResponse(
    ...
    >
      ...
      >
        Deploy AI agents that remember, plan, and execute together
      </div>
