...
const sections = [
  {
    ...
    links: [
      { name: 'Quick Start Guide', href: '/docs/guides' },
      { name: 'Creating Your First Project', href: '/docs/guides' },
      { name: 'Understanding Agents', href: '/docs/guides' },
    ],
  },
  {
    title: 'API Reference',
    ...
    links: [
      ...
      { name: 'Sessions API', href: '/docs/api' },
      { name: 'Agents API', href: '/docs/api' },
    ],
  },
  {
    title: 'Guides',
    ...
    color: 'agent-3',
    links: [
      { name: 'Working with Agents', href: '/docs/guides' },
      { name: 'Git Integration', href: '/docs/guides' },
      { name: 'Team Collaboration', href: '/docs/guides' },
    ],
  },
  {
    title: 'Features',
    ...
    links: [
      { name: 'Agent Memory', href: '/docs/guides' },
      { name: 'Vision Analysis', href: '/docs/guides' },
      { name: 'Voice Commands', href: '/docs/guides' },
    ],
  },
];
