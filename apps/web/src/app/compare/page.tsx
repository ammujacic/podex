        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Compare Podex with other AI coding tools. See how multi-agent collaboration,
              persistent memory, and cloud IDE capabilities stack up against single-agent
              assistants.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="p-6 rounded-xl bg-agent-3/10 border border-agent-3/30">
              ...
              <p className="text-sm text-text-muted">
                Full development environment in the browser with integrated AI, not just a plugin
