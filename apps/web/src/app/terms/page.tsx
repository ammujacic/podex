        ...
        <div className="mx-auto max-w-3xl px-4 lg:px-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="text-text-secondary">
                Podex is a web-based development platform that provides AI-powered coding
                assistance, cloud computing resources, and collaboration tools. We reserve the right
                to modify, suspend, or discontinue any aspect of the Service at any time.
              </p>
            </section>
