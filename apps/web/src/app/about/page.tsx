          ...
          <div className="mx-auto max-w-4xl px-4 lg:px-8">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-text-secondary text-lg leading-relaxed mb-4">
                Podex was born from a simple observation: developers spend too much time on
                repetitive tasks that AI could handle better. We saw the potential of large language
                models and knew they could transform how software is built.
              </p>
              <p className="text-text-secondary text-lg leading-relaxed mb-4">
