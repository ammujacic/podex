    ...
    <div className="min-h-screen bg-void py-24 lg:py-32">
      <div className="mx-auto max-w-4xl px-4 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-text-secondary">Current status of Podex services and infrastructure</p>
        </div>
        ...
        >
          {allOperational ? (
            <>
              ...
              <h2 className="text-2xl font-bold text-text-primary mb-2">All Systems Operational</h2>
