...
const securityFeatures = [
  ...
  },
  {
    ...
    description:
      'Our infrastructure is hosted on secure cloud providers with 24/7 monitoring and automated security patching.',
  },
];
...
const compliance = [
  { name: 'SOC 2 Type II', status: 'Roadmap', description: 'Enterprise security certification' },
  { name: 'GDPR', status: 'Roadmap', description: 'EU data protection' },
  { name: 'CCPA', status: 'Roadmap', description: 'California privacy law' },
        ...
        <div className="mx-auto max-w-4xl px-4 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-2xl mx-auto">
              Your code is your intellectual property. We take security seriously to ensure your
            ...
            <div className="p-6 rounded-xl bg-surface border border-border-default space-y-6">
              <div>
                ...
                <p className="text-text-muted text-sm">
                  Your code is never used to train AI models. We process your code only to provide
                  the requested services and features.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-text-primary mb-2">Data Retention</h3>
                <p className="text-text-muted text-sm">
                  We retain your data only as long as your account is active. Upon deletion, your
