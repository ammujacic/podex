          ...
          for (const [agentId, progressList] of Object.entries(newState)) {
            ...
            if (idx !== -1) {
              newState[agentId] = [
                ...
                { ...progressList[idx], ...updates } as TaskProgress,
        ...
        set((state) => {
          ...
          for (const [agentId, progressList] of Object.entries(newState)) {
            ...
            if (idx !== -1) {
              ...
              if (stepIndex < newSteps.length && newSteps[stepIndex]) {
                newSteps[stepIndex] = { ...newSteps[stepIndex], ...updates } as ProgressStep;
              }
              ...
              newState[agentId] = [
                ...
                {
                  ...progress,
                  steps: newSteps as ProgressStep[],
                  completedSteps,
