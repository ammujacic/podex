...
export function MobileSessionOverview({
  ...
  // Attention state
  const { getUnreadCountForAgent, getHighestPriorityAttention, hasUnreadForAgent, openPanel } =
    useAttentionStore();
                  ...
                  >
                    ...
                    >
                      {isProcessing ? (
                        ...
                        <Bot className="h-8 w-8" style={{ color }} />
                      )}
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {agentHighestPriority && attentionStyles && (
                          <button
                            ...
                            aria-label={`Open notifications: ${getAttentionTypeLabel(agentHighestPriority.type)}`}
                          >
