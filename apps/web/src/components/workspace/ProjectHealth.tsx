...
export default function ProjectHealth({ sessionId, compact = false }: ProjectHealthProps) {
  ...
  return (
    <div className="border border-border-default rounded-lg overflow-hidden bg-surface">
      ...
      <button
        ...
        className="w-full p-3 flex items-center justify-between hover:bg-overlay/50 transition-colors"
      >
        <div className="flex items-center gap-2">
