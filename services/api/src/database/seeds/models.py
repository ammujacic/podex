...
DEFAULT_MODELS = [
    ...
    # ====================
    # OAUTH SUBSCRIPTION MODELS
    # These use personal subscriptions (ChatGPT Plus, Copilot, etc.)
    # Cost is 0 since user pays via their subscription
    # ====================
    # OpenAI Codex (ChatGPT Plus/Pro OAuth)
    {
        ...
        "sort_order": 2000,
        "model_metadata": {
            "description": "Latest Codex model via ChatGPT subscription",
            "good_for": ["Coding", "Agentic Tasks", "Complex Reasoning"],
            "oauth_provider": "openai-codex",
        },
    },
    {
        "model_id": "openai-codex/gpt-5.1-codex",
        ...
        "sort_order": 2010,
        "model_metadata": {
            "description": "GPT-5.1 Codex via ChatGPT subscription",
            "good_for": ["Coding", "Agentic Tasks", "Analysis"],
            "oauth_provider": "openai-codex",
        },
    },
    {
        "model_id": "openai-codex/gpt-5.1-codex-max",
        ...
        "sort_order": 2020,
        "model_metadata": {
            "description": "Extended context Codex for long-running tasks",
            "good_for": ["Complex Coding", "Long Documents", "Architecture"],
            "oauth_provider": "openai-codex",
        },
    },
    {
        "model_id": "openai-codex/gpt-5.1-codex-mini",
        ...
        "sort_order": 2030,
        "model_metadata": {
            "description": "Fast Codex variant for quick tasks",
            "good_for": ["Quick Tasks", "Efficient Coding", "Budget"],
            "oauth_provider": "openai-codex",
        },
    },
    {
        "model_id": "openai-codex/codex-mini-latest",
        ...
        "sort_order": 2040,
        "model_metadata": {
            "description": "Auto-switches at 90% usage limit",
            "good_for": ["High Volume", "Continuous Usage", "Budget"],
            "oauth_provider": "openai-codex",
        },
    },
    # GitHub Copilot Models (via Copilot subscription OAuth)
    {
        "model_id": "github-copilot/gpt-5.2-codex",
        "display_name": "GPT-5.2 Codex (Copilot)",
        ...
        "sort_order": 2100,
        "model_metadata": {
            "description": "Latest Codex via GitHub Copilot subscription",
            "good_for": ["Coding", "Agentic Tasks", "Complex Reasoning"],
            "oauth_provider": "github-copilot",
        },
    },
    {
        "model_id": "github-copilot/gpt-5.1-codex",
        "display_name": "GPT-5.1 Codex (Copilot)",
        "provider": "github-copilot",
        "family": "openai",
        "cost_tier": "free",
        "capabilities": {
        ...
        "sort_order": 2110,
        "model_metadata": {
            "description": "GPT-5.1 Codex via Copilot",
            "good_for": ["Coding", "Agentic Tasks", "Analysis"],
            "oauth_provider": "github-copilot",
        },
    },
    {
        "model_id": "github-copilot/claude-sonnet-4.5",
        ...
        "sort_order": 2120,
        "model_metadata": {
            "description": "Claude Sonnet via Copilot subscription",
            "good_for": ["Coding", "Analysis", "Agentic Tasks"],
            "oauth_provider": "github-copilot",
        },
    },
    {
        ...
        "display_name": "Claude Sonnet 4 (Copilot)",
        "provider": "github-copilot",
        "family": "anthropic",
        "cost_tier": "free",
        "capabilities": {
        ...
        "sort_order": 2130,
        "model_metadata": {
            "description": "Claude Sonnet 4 via Copilot subscription",
            "good_for": ["Coding", "Analysis", "Agentic Tasks"],
            "oauth_provider": "github-copilot",
        },
    },
    {
        "model_id": "github-copilot/claude-opus-4.5",
        "display_name": "Claude Opus 4.5 (Copilot)",
        "provider": "github-copilot",
        "family": "anthropic",
        "cost_tier": "free",
        "capabilities": {
        ...
        "sort_order": 2140,
        "model_metadata": {
            "description": "Claude Opus via Copilot subscription",
            "good_for": ["Complex Coding", "Architecture", "Deep Analysis"],
            "oauth_provider": "github-copilot",
        },
    },
    {
        "model_id": "github-copilot/gemini-2.5-pro",
        ...
        "sort_order": 2150,
        "model_metadata": {
            "description": "Gemini 2.5 Pro via Copilot subscription",
            "good_for": ["Long Context", "Complex Reasoning", "Coding"],
            "oauth_provider": "github-copilot",
        },
    },
    {
        "model_id": "github-copilot/gemini-3-flash-preview",
        "display_name": "Gemini 3 Flash Preview (Copilot)",
        "provider": "github-copilot",
        "family": "google",
        "cost_tier": "free",
        "capabilities": {
        ...
        "sort_order": 2160,
        "model_metadata": {
            "description": "Latest Gemini 3 Flash via Copilot",
            "good_for": ["Fast Tasks", "Long Context", "Multimodal"],
            "oauth_provider": "github-copilot",
        },
    },
    {
        "model_id": "github-copilot/grok-code-fast-1",
        "display_name": "Grok Code Fast (Copilot)",
        "provider": "github-copilot",
        "family": "xai",
        "cost_tier": "free",
        "capabilities": {
        ...
        "sort_order": 2170,
        "model_metadata": {
            "description": "xAI Grok via Copilot subscription",
            "good_for": ["Fast Coding", "Quick Tasks"],
            "oauth_provider": "github-copilot",
        },
    },
    # Google Gemini CLI Models (via Google OAuth)
    {
        "model_id": "google-gemini-cli/gemini-2.5-flash",
        ...
        "sort_order": 2200,
        "model_metadata": {
            "description": "Gemini 2.5 Flash via Google account (free tier)",
            "good_for": ["Fast Tasks", "Long Context", "Free Usage"],
            "oauth_provider": "google-gemini-cli",
        },
    },
    {
        "model_id": "google-gemini-cli/gemini-2.5-pro",
        ...
        "sort_order": 2210,
        "model_metadata": {
            "description": "Gemini 2.5 Pro via Google account",
            "good_for": ["Complex Reasoning", "Long Context", "Coding"],
            "oauth_provider": "google-gemini-cli",
        },
    },
    {
        "model_id": "google-gemini-cli/gemini-3-flash-preview",
        "display_name": "Gemini 3 Flash Preview (CLI)",
        "provider": "google-gemini-cli",
        "family": "google",
        "cost_tier": "free",
        "capabilities": {
        ...
        "sort_order": 2220,
        "model_metadata": {
            "description": "Latest Gemini 3 Flash via Google account",
            "good_for": ["Fast Tasks", "Latest Features", "Multimodal"],
            "oauth_provider": "google-gemini-cli",
        },
    },
    {
        ...
        "sort_order": 2230,
        "model_metadata": {
            "description": "Latest Gemini 3 Pro via Google account",
            "good_for": ["Complex Reasoning", "Latest Features", "Coding"],
            "oauth_provider": "google-gemini-cli",
        },
    },
]
