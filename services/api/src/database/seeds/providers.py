...
DEFAULT_PROVIDERS: list[LLMProviderData] = [
    ...
    # OAuth-based providers (use personal subscriptions)
    {
        "slug": "openai-codex",
        "name": "OpenAI Codex",
        "description": "GPT-5.2 Codex via ChatGPT Plus/Pro subscription. OAuth authentication.",
        "icon": "Terminal",
        "color": "#10A37F",
        "is_local": False,
        "docs_url": "https://chatgpt.com/",
        "setup_guide_url": "https://chatgpt.com/",
    ...
    },
    {
        "slug": "github-copilot",
        "name": "GitHub Copilot",
        "description": "GPT, Claude, and Gemini models via GitHub Copilot. OAuth auth.",
        "icon": "Github",
        "color": "#24292E",
        "is_local": False,
        "docs_url": "https://github.com/features/copilot",
        "setup_guide_url": "https://docs.github.com/en/copilot",
        "requires_api_key": False,  # Uses OAuth
        "supports_streaming": True,
        "supports_tools": True,
        "supports_vision": True,
    ...
    },
    {
        ...
        "description": "Gemini 2.5/3 models via Google account. Free tier supported.",
        "icon": "Sparkles",
        "color": "#4285F4",
        "is_local": False,
        "docs_url": "https://ai.google.dev/",
